...
public class Bbpmain extends JFrame {	
	...
	//========================================	
	private JLabel exLabel1 = new JLabel("책목록입니다");
	...
	public void compinit(){
		...
		this.listPanel.setBackground(Color.ORANGE);	
		...
		this.shcoolPanel.setBackground(Color.BLACK);	
		...
		this.cardPanel.setBounds(30, 190, 420, 590);
		this.add(cardPanel);
	}
